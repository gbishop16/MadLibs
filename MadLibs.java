...
public class MadLibs {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		BufferedReader brd = new BufferedReader(new FileReader("nouns.txt"));
		...
		BufferedReader reader4 = new BufferedReader(new FileReader("adverbs.txt"));
		while((char)reader4.read() != '') {
